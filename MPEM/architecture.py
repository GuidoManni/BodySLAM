...
class MultiTaskModel(nn.Module):
    ...
    def forward(self, stacked_frame=None, task='pose'):
        if task == "pose":
            ...
            rotation_vec = normalize_quaternion(rotation_vec)  # Assuming normalize_quaternion is defined elsewhere
            rotation_matrix = quaternion_to_matrix(rotation_vec)  # Assuming quaternion_to_matrix is defined elsewhere
