...
# Internal Module
from architecture_v2 import MultiTaskModel, ConditionalGenerator
...
parser.add_argument("--input_shape", type=int, nargs=3, default=[8, 256, 256], help="Input shape as a list (default: [3, 256, 256])")
