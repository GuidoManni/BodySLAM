...
# Internal Modules
from UTILS.io_utils import XlsxIO, CSVIO
...
def compute_metrics(dataset_paths, predictions, results_path):
    ...
    for folder in dataset_paths.keys():
        ...
        rel_ground_truth = xlsxIO.read_xlsx_pose_file(dataset_paths[folder]['Poses'])
        ...
        abs_ground_truth = poseOperator.get_relative_poses(rel_ground_truth)

        # step 2: compute the metrics
        ATE, ARE = mpem_metrics.compute_ARE_and_ATE(abs_ground_truth, abs_prediction)
        ...
        save_results(folder, results_path, metrics)
